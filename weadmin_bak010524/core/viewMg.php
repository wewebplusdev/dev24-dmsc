    ...
    <div class="divRightMain">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr id="rowURL" <? if ($valModuletype == "Module" || $valModuletype == "Group") { ?> style="display:none" <? } ?>>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            ...
            ?>
            <div class="formDivView"><?= $valLinkShow ?></div>
          </td>
        </tr>
        <tr id="rowModuleKey" <? if ($valModuletype == "Group" || $valModuletype == "Link") { ?> style="display:none" <? } ?>>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <div class="formDivView"><?= $valMasterkey ?></div>
          </td>
        </tr>
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <?php if ($valIcontype != "2" || $valIcontype == "") { ?>
            <div class="formDivView"><img src="<?= $valIcon ?>" name="LibraryIconSample" id="LibraryIconSample" onerror="this.src='<?= "../img/btn/blank.gif" ?>'" /></div>
            <?php }else{ ?>
              <span class="material-symbols-outlined "><?php echo $valClassName ?></span>
            <?php } ?>
          </td>
        </tr>
      </table>
