      ...
      <div class="divRightMain">
         ...
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb"><input name="inputKeywords" id="inputKeywords" type="text" class="formInputContantTb" /></td>
            </tr>
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb"><input name="inputNumbers" id="inputNumbers" type="number" class="formInputContantTbShot" /></td>
            </tr>
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb"><input name="inputSuffix" id="inputSuffix" type="text" class="formInputContantTb" /></td>
            </tr>
            <?php } ?>
            <tr>
