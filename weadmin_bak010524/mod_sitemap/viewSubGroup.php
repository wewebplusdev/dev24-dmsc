...
$sql .= "
			" . $mod_tb_subgroup . "_id ,
			" . $mod_tb_subgroup . "_credate ,
			" . $mod_tb_subgroup . "_crebyid,
			" . $mod_tb_subgroup . "_status,
			" . $mod_tb_subgroup . "_sdate      ,
			" . $mod_tb_subgroup . "_edate    ,
			" . $mod_tb_subgroup_lang . "_lastdate,
			" . $mod_tb_subgroup_lang . "_subject ,
			" . $mod_tb_subgroup_lang . "_lastbyid,
...
$sql .= "  WHERE " . $mod_tb_subgroup . "_masterkey='" . $_REQUEST["masterkey"] . "'  AND  " . $mod_tb_subgroup . "_id='" . $_REQUEST['valEditID'] . "' AND " . $mod_tb_subgroup_lang . "_language = '" . $_REQUEST['inputLt'] . "'";
   ...
   <form action="?" method="get" name="myForm" id="myForm">
      ...
      <?php if ($_REQUEST['viewID'] <= 0) { ?>
         <div class="divRightNav">
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
               <tr>
                  <td class="divRightNavTb" align="left" id="defTop"><span class="fontContantTbNav"><a href="<?php echo $valLinkNav1 ?>" target="_self"><?php echo $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a href="javascript:void(0)" onclick="btnBackPage('subgroup.php')" target="_self"><?php echo $langMod["meu:subgroup"] ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php echo $langMod["txt:titleviewsg"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>(<?php echo $_REQUEST['inputLt']; ?>)<?php } ?></span></td>
      ...
      <div class="divRightHead">
         <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center">
            <tr>
               <td height="77" align="left"><span class="fontHeadRight"><?php echo $langMod["txt:titleviewsg"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>(<?php echo $_REQUEST['inputLt']; ?>)<?php } ?></span></td>
               <td align="left">
