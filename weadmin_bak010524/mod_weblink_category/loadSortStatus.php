...
<form action="?" method="get" name="myForm" id="myForm">
    ...
    <input name="inputStatus" type="hidden" id="inputStatus" value="<?php echo $_REQUEST['inputStatus']?>" />
                                            ...
                                            <table  border="0" cellspacing="0" cellpadding="0" align="right">
                                                <tr>
                                                    ...
                                                    <?php if($valPermission=="RW"){ ?>
                                                        <div  class="btnSave" title="<?php echo $langTxt["btn:save"]?>" onclick="sortingContactNew('sortingStatus.php');"></div><?php } ?>
...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" style="	border-top:#c8c7cc solid 1px;">
  <tr >
    ...
    if(!empty($_REQUEST['inputStatus'])){
      $sql .= " AND ".$mod_tb_root_group."_status = '".$_REQUEST['inputStatus']."' ";
    }

		$sql .= " ORDER BY ".$mod_tb_root_group."_orderstatus DESC";
