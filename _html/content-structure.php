                ...
                <div class="editor-content">
                    <div class="container">
                        <div class="layout-structure ">
                            ...
                            <div class="row ">
                                <div class="item col-xl-6 no-gutters ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 card-bottom position-relative">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold text-primary">นายแพทย์ยงยศ ธรรมวุฒิ</div>
                                ...
                                <div class="item col-xl-6 no-gutters ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="position-relative card-top col-auto">
                                            <div class="image-cover position-absolute ">
                                                <img src="<?php echo $core_template; ?>/img/uploads/structure/structure-2.png" alt="นายแพทย์พิเชฐ บัญญัติ">
                                            </div>
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 card-bottom  position-relative ">
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายแพทย์พิเชฐ บัญญัติ</div>
                                                <div class="font20">อธิบดีกรมวิทยาศาสตร์การแพทย์</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 card-bottom  position-relative ">
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายแพทย์บัลลังก์ อุปพงษ์</div>
                                ...
                                <div class="item col-xl-6 no-gutters ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom card-bottom">
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายแพทย์ปิยะ ศิริลักษณ์</div>
                                                <div class="font20">รองอธิบดีกรมวิทยาศาสตร์การแพทย์</div>
                                            </div>
                                            <div class="typo-xs contact">
                            ...
                            <div class="row  ">
                                <div class="item col-xl-6 no-gutters">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom card-bottom">
                                            <div>
                                                <div class="typo-md title-name fw-bold text-primary">นายชาญยุทธ แสนเลิศ</div>
                                ...
                                <div class="item col-xl-6 no-gutters">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom card-bottom">
                                            <div>
                                                <div class="typo-md title-name fw-bold text-primary">นางสุวรรณา เจริญสวรรค์</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสุกัญญา กำแพงแก้ว</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสาวนันทวรรณ เมฆา</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายอาชวินทร์ โรจนวิวัฒน์</div>
                                                <div class="font20">ผู้อำนวยการสถาบันวิจัยวิทยาศาสตร์
                                                    สาธารณสุข</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางศิริวรรณ ชัยสมบูรณ์พันธ์</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางวิชาดา จงมีวาสนา</div>
                                                <div class="font20">ผู้อำนวยการสำนักคุณภาพ
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสาวจรรยา มีศรี</div>
                                                <div class="font20">ผู้อำนวยการสำนักเครื่องสำอาง
                                                    และวัตถุอันตราย</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายธรรมรัตน์ บุญสูง</div>
                                            ...
                                            <div class="typo-xs contact">
                                                <a href="mailto:thamarat.b@dmsc.mail.go.th">
                                                    <div  class="d-flex align-items-center ">
                                                        <div class=" text-nowrap ">Email :</div>
                                                        <div class="">thamarat.b@dmsc.mail.go.th</div>
                                                    </div>
                                                </a>
                                                <div  class="d-flex align-items-center ">
                                                    <div class=" text-nowrap">ติดต่อ :</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายสุรศักดิ์ หมื่นพล</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายสมศักดิ์ สุนทรพาณิชย์</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายปนิสภ์ วณิชชานนท์</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสาวปนัดดา เทพอัคศร</div>
                                                <div class="font20">ผู้อำนวยการสถาบันชีววิทยาศาสตร์
                                                    ทางการแพทย์</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">ดร.ประไพ วงศ์สินคงมั่น</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">ดร.ฐิติวัสส์ สุวคนธ์</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสาวสุจิตรา คุ้มโภคา</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายอธิวัฒน์ ปริมสิริคุณาวุฒิ</div>
                                                <div class="font20">ผู้อำนวยการกองความร่วมมือ
                                                    ระหว่างประเทศ</div>
                                            </div>
                                            <div class="typo-xs contact">
                                                <a href="mailto:athiwat.p@dmsc.mail.go.th">
                                                    <div  class="d-flex align-items-center ">
                                                        <div class=" text-nowrap ">Email :</div>
                                                        <div class="">athiwat.p@dmsc.mail.go.th</div>
                                                    </div>
                                                </a>
                                                <div  class="d-flex align-items-center ">
                                                    <div class=" text-nowrap">ติดต่อ :</div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสาวนิตยา เพียรทรัพย์</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                                    ที่ 1 เชียงใหม่</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสาวอัมรา โยวัง</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสาวอมรรัตน์ ทัศนกิจ</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                                    ที่ 2 พิษณุโลก</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายอัศวชัย ช่วยพรหม</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                                    ที่ 3 นครสวรรค์</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางทรรศนีย์ มาศจำรัส</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                                    ที่ 4 สระบุรี</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางปานทิพย์ ศิริโชติ</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางเกตุ สินเทศ</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                                    ที่ 6 ชลบุรี</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสาวพรทิพย์ ลัภนะกุล</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                                    ที่ 7 ขอนแก่น</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสาวอรทัย สุพรรณ</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                                    ที่ 8 อุดรธานี</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายสันตกิจ นิลอุดมศักดิ์</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                            ...
                                            <div class="typo-xs contact">
                                                <a href="mailto:santakit.n@dmsc.mail.go.th">
                                                    <div  class="d-flex align-items-center ">
                                                        <div class=" text-nowrap ">Email :</div>
                                                        <div class="">santakit.n@dmsc.mail.go.th</div>
                                                    </div>
                                                </a>
                                                <a href="tel:044346005">
                                                    <div  class="d-flex align-items-center ">
                                                        <div class=" text-nowrap">ติดต่อ :</div>
                                                        <div class="">0-4434-6005</div>
                                                    </div>
                                                </a>
                                            </div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางมธุรส ทาทอง</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                            ...
                                            <div class="typo-xs contact">
                                                <a href="mailto:mathurose.t@dmsc.mail.go.th">
                                                    <div  class="d-flex align-items-center ">
                                                        <div class=" text-nowrap ">Email :</div>
                                                        <div class="">mathurose.t@dmsc.mail.go.th</div>
                                                    </div>
                                                </a>
                                                <a href="tel:0454312230">
                                                    <div  class="d-flex align-items-center ">
                                                        <div class=" text-nowrap">ติดต่อ :</div>
                                                        <div class="">0-4531-2230</div>
                                                    </div>
                                                </a>
                                            </div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสาวจิราภรณ์ เพชรรักษ์ </div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                            ...
                                            <div class="typo-xs contact">
                                                <a href="mailto:jiraporn.p@dmsc.mail.go.th">
                                                    <div  class="d-flex align-items-center ">
                                                        <div class=" text-nowrap ">Email :</div>
                                                        <div class="">jiraporn.p@dmsc.mail.go.th</div>
                                                    </div>
                                                </a>
                                                <a href="tel:077355301">
                                                    <div  class="d-flex align-items-center ">
                                                        <div class=" text-nowrap">ติดต่อ :</div>
                                                        <div class="">0-7735-5301</div>
                                                    </div>
                                                </a>
                                            </div>
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นางสุภาภรณ์ นิยมแก้ว</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                                    ที่ 11/1 ภูเก็ต</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters  ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom ">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">ดร.วราพร ชลอำไพ</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                                    ที่ 12 สงขลา</div>
                                            </div>
                                            <div class="typo-xs contact">
                                ...
                                <div class="item col-xl-6 no-gutters ">
                                    <div class="item-wrapper row no-gutters">
                                        ...
                                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-7 position-relative card-bottom card-bottom">
                                            ...
                                            <div>
                                                <div class="typo-md title-name fw-bold  text-primary ">นายคทายุทธ นิกาพฤกษ์</div>
                                                <div class="font20">ผู้อำนวยการศูนย์วิทยาศาสตร์การแพทย์
                                                    ที่ 12/1 ตรัง</div>
                                            </div>
                                            <div class="typo-xs contact">
                            ...
                            <div class="fw-bold mt-5 bottom-content">
                                <div class="mb-3 typo-md title-name">ปรับปรุงข้อมูล 29 กุมภาพันธ์ 2567</div>
                                <div class="fw-light"> หากพบข้อผิดพลาดกรุณาติดต่อ สีหนาท ศิวเสน ศูนย์เทคโนโลยีสารสนเทศเบอร์โทรศัพท์ 98808 หรือเบอร์โทรศัพท์ 915113</div>
                            </div>
