        ...
        <div class="detail-body">
          <div class="default-bar">
            <div class="container">
              <div class="topbar">
                <div class="whead">
                  <h2 class="title">กรมวิทย์ฯเผยผลการเฝ้าระวังสายพันธุ์ของเชื้อไข้หวัดใหญ่ ย้ำวัคซีน ที่ฉีดยังสามารถป้องกันไข้หวัดใหญ่ได้</h2>
                </div>
              </div>
                                ...
                                <svg id="view-2" xmlns="http://www.w3.org/2000/svg" width="25" height="15.934" viewBox="0 0 25 15.934">
                                  <g id="Group_90612" data-name="Group 90612">
                                    <g id="Group_90611" data-name="Group 90611">
                                      <path id="Path_452477" data-name="Path 452477" d="M24.841,11.107C24.618,10.8,19.3,3.626,12.5,3.626S.382,10.8.159,11.107a.825.825,0,0,0,0,.973C.382,12.385,5.7,19.56,12.5,19.56s12.118-7.175,12.341-7.481A.824.824,0,0,0,24.841,11.107ZM12.5,17.912c-5.006,0-9.342-4.762-10.626-6.319C3.156,10.035,7.483,5.275,12.5,5.275s9.342,4.762,10.626,6.319C21.844,13.152,17.517,17.912,12.5,17.912Z" transform="translate(0 -3.626)" fill="#2ab170" />
                                    </g>
                                  </g>
                                  <g id="Group_90614" data-name="Group 90614" transform="translate(7.555 3.022)">
                                    <g id="Group_90613" data-name="Group 90613">
                                      <path id="Path_452478" data-name="Path 452478" d="M10.989,6.044a4.945,4.945,0,1,0,4.945,4.945A4.951,4.951,0,0,0,10.989,6.044Zm0,8.242a3.3,3.3,0,1,1,3.3-3.3A3.3,3.3,0,0,1,10.989,14.286Z" transform="translate(-6.044 -6.044)" fill="#2ab170" />
                                    </g>
                                  </g>
                                </svg>
                              </span>
                            ...
                            <a href="#" class="link" title="facebook">
                              <span class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="11.352" height="20" viewBox="0 0 11.352 20">
                                  <path id="facebook" d="M7.036,20h-3.2a.971.971,0,0,1-.97-.97V11.806H.995a.971.971,0,0,1-.97-.97V7.74a.971.971,0,0,1,.97-.97H2.863V5.22a5.278,5.278,0,0,1,1.4-3.781A5.027,5.027,0,0,1,7.965,0l2.443,0a.972.972,0,0,1,.968.97V3.848a.971.971,0,0,1-.97.97H8.762c-.5,0-.629.1-.657.131-.045.051-.1.2-.1.595V6.77h2.276a.986.986,0,0,1,.48.122.974.974,0,0,1,.5.849v3.1a.971.971,0,0,1-.97.97H8.006V19.03A.971.971,0,0,1,7.036,20Zm-3-1.172h2.8V11.281a.649.649,0,0,1,.648-.648h2.607V7.942H7.481a.648.648,0,0,1-.648-.648V5.545a2,2,0,0,1,.392-1.371,1.987,1.987,0,0,1,1.535-.528H10.2V1.176l-2.24,0A3.7,3.7,0,0,0,4.036,5.22V7.295a.648.648,0,0,1-.648.648H1.2v2.691H3.388a.648.648,0,0,1,.648.648Zm6.37-17.651h0Zm0,0" transform="translate(-0.024)" fill="#2ab170" />
                                </svg>
                              </span>
                            </a>
                          </li>
                          <li>
                            <a href="#" class="link" title="x">
                              <span class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="19.57" height="20" viewBox="0 0 19.57 20">
                                  <path id="twitter" d="M11.883,8.469,19.169,0H17.442L11.116,7.353,6.064,0H.237l7.64,11.119L.237,20H1.963l6.68-7.765L13.979,20h5.827L11.883,8.469ZM9.519,11.217,8.745,10.11,2.585,1.3H5.237l4.971,7.11.774,1.107,6.461,9.242H14.791L9.519,11.218Z" transform="translate(-0.237)" fill="#2ab170" />
                                </svg>
                              </span>
                            </a>
                          </li>
                          <li>
                            <a href="#" class="link" title="email">
                              <span class="icon">
                                <svg id="mail" xmlns="http://www.w3.org/2000/svg" width="20" height="14.063" viewBox="0 0 20 14.063">
                                  <g id="Group_90602" data-name="Group 90602" transform="translate(0 0)">
                                    <path id="Path_452472" data-name="Path 452472" d="M18.242,3.266H1.758A1.76,1.76,0,0,0,0,5.023V15.57a1.76,1.76,0,0,0,1.758,1.758H18.242A1.76,1.76,0,0,0,20,15.57V5.023A1.76,1.76,0,0,0,18.242,3.266ZM18,4.438l-6.753,6.717a1.758,1.758,0,0,1-2.487,0L2,4.438ZM1.172,15.332V5.263L6.236,10.3ZM2,16.156l5.062-5.03.862.857a2.93,2.93,0,0,0,4.142,0l.863-.858L18,16.156Zm16.823-.824L13.764,10.3l5.064-5.037Z" transform="translate(0 -3.266)" fill="#2ab170" />
                                  </g>
                                </svg>
                              </span>
                            </a>
          ...
          <div class="editor-content">
            <div class="container">
              <img src="<?php echo $core_template; ?>/img/uploads/img-news-detail.jpg" alt="" style=" margin-bottom: 20px;">
              <p>
                วันนี้ (11 มีนาคม 2567) ที่โรงแรมมิราเคิล แกรนด์ คอนเวนชั่น กรุงเทพฯ นายแพทย์ยงยศ ธรรมวุฒิ อธิบดีกรมวิทยาศาสตร์การแพทย์ เปิดการประชุมสัมมนาผู้
                มีส่วนได้ส่วนเสีย ผู้รับบริการ และบูรณาการแผนงานด้านยาเสพติดของกรมวิทยาศาสตร์การแพทย์ ปีงบประมาณ พ.ศ.2567 โดยมีผู้บริหาร จากกรมวิทยาศาสตร์การ
                แพทย์ วิทยากรจากสำนักงาน ป.ป.ส. สำนักงานตำรวจแห่งชาติ อย. และผู้ปฏิบัติงานจากหน่วยงานภาครัฐและเอกชนที่เกี่ยวข้อง เช่น สำนักงานตำรวจแห่งชาติ โรง
                พยาบาลภาครัฐ สำนักงานพิสูจน์หลักฐานตำรวจ โรงพยาบาลตำรวจ สถาบันนิติวิทยาศาสตร์ ห้องปฏิบัติการโรงพยาบาลภาคเอกชน เป็นต้น และเจ้าหน้าที่สำนักยาและ
                วัตถุเสพติด ศูนย์วิทยาศาสตร์การแพทย์ เข้าร่วมประชุมกว่า 300 คน
              </p>
            </div>
          </div>
          <!-- ck editor -->
                          ...
                          <div class="row gutters-20 aling-items-start">
                            ...
                            <div class="col">
                              <div class="desc">
                                ...
                                ซึ่งการสมัครเข้าร่วม
                              </div>
                              <div class="type-file">
                                <ul class="item-list">
                                  <li>
                                    <strong>ประเภทไฟล์ :</strong> <span>.pdf</span>
                                  </li>
                                  <li>
                                    <strong>ขนาดไฟล์ :</strong> <span>25 Mb</span>
                                  </li>
                                  <li>
                                    <strong>ดาวน์โหลด :</strong> <span>15 ครั้ง</span>
                                  </li>
                                </ul>
                              </div>
                            </div>
          ...
          <div class="news-area">
            <div class="container">
              <div class="whead">
                <h2 class="title text-center">ข่าวประชาสัมพันธ์เกี่ยวข้อง</h2>
              </div>
              <div class="swiper">
                <div class="swiper-wrapper">
                  <?php for ($i = 1; $i <= 5; $i++) { ?>
