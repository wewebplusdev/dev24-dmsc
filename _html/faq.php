          ...
          <div class="container">
            <form action="" class="form-default">
              <div class="whead my-0">
                <div class="title mb-3">ค้นหา</div>
              </div>
          ...
          <div class="layout-faq" id="accordion">
            <div class="card">
              <div class="card-header" id="headingOne">
                <a href="" class="link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                  <div class="row gutters-10 align-items-center">
                    <div class="col-auto">
                      <div class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="31.229" height="31.229" viewBox="0 0 31.229 31.229">
                          <defs>
                            <clipPath id="clip-path">
                              <path id="path3592" d="M0-682.665H31.229v31.229H0Z" transform="translate(0 682.665)" fill="#fff" />
                            </clipPath>
                          </defs>
                          <g id="g3590" clip-path="url(#clip-path)">
                            <g id="g3596" transform="translate(0.61 0.61)">
                              <path id="path3598" d="M-490.329-55.018A15.01,15.01,0,0,0-509.44-53.26h0A15.008,15.008,0,0,0-510.9-33.735l-1.155,4.311,4.311-1.155A15.008,15.008,0,0,0-488.22-32.04h0a15.01,15.01,0,0,0,1.757-19.112" transform="translate(513.835 57.655)" fill="none" stroke="#01377e" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" />
                            </g>
                            <g id="g3600" transform="translate(10.214 6.201)">
                              <path id="path3602" d="M-27.731-114.492a1.308,1.308,0,0,1-1.265-1.7,5.472,5.472,0,0,1,1.432-2.263,5.462,5.462,0,0,1,4.059-1.517,5.467,5.467,0,0,1,3.6,1.638,5.467,5.467,0,0,1,1.638,3.6,5.518,5.518,0,0,1-3.026,5.177,2.075,2.075,0,0,0-1.161,1.855h0A1.308,1.308,0,0,1-23.76-106.4h-.005a1.308,1.308,0,0,1-1.308-1.308h0a4.683,4.683,0,0,1,2.6-4.2,2.893,2.893,0,0,0,1.586-2.715,3.014,3.014,0,0,0-2.742-2.742,2.862,2.862,0,0,0-2.129.795,2.867,2.867,0,0,0-.741,1.156A1.325,1.325,0,0,1-27.731-114.492Z" transform="translate(29.06 119.981)" fill="none" stroke="#01377e" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" />
                            </g>
                            <g id="g3604" transform="translate(14.201 22.407)">
                              <path id="path3606" d="M-54.672-27.336a1.31,1.31,0,0,1-1.31,1.31,1.31,1.31,0,0,1-1.31-1.31,1.31,1.31,0,0,1,1.31-1.31A1.31,1.31,0,0,1-54.672-27.336Z" transform="translate(57.293 28.647)" fill="none" stroke="#01377e" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" />
                            </g>
                          </g>
                        </svg>
                      </div>
                    ...
                    <div class="col">
                      <div class="title">แผนที่ตั้งกรมวิทยาศาสตร์การแพทย์ กระทรวงสาธารณสุข</div>
                    </div>
                  </div>
                </a>
              </div>
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                  <div class="row gutters-10 align-items-start">
                    <div class="col-auto">
                      <div class="icon">
                        <svg id="Group_90476" data-name="Group 90476" xmlns="http://www.w3.org/2000/svg" width="30.002" height="30.002" viewBox="0 0 30.002 30.002">
            ...
            <div class="card">
              <div class="card-header" id="headingTwo">
                <a href="" class="link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                  <div class="row gutters-10 align-items-center">
                    <div class="col-auto">
                      <div class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="31.229" height="31.229" viewBox="0 0 31.229 31.229">
