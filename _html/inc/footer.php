<footer class="layout-footer">
  <div class="footer-content lazy" data-bg="<?php echo $core_template; ?>/img/background/bg-footer.webp" data-bg-hidpi="<?php echo $core_template; ?>/img/background/bg-footer@2x.webp">
    <div class="container">
