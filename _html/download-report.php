                ...
                <div class="row align-items-center">
                  <div class="col">
                    <div class="whead my-0">
                      <div class="title">รายงานประจำปี</div>
                    </div>
                  </div>
                  <div class="col-auto">
                    <div class="row gutters-20">
                      <div class="col-auto">
                        <div class="document-filter mb-0">
                        ...
                        <div class="layout-view layout-list">
                          <div class="btn-group">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30" viewBox="0 0 30 30">
                                  <defs>
                                    <clipPath id="clip-path">
                                      <rect id="Rectangle_17247" data-name="Rectangle 17247" width="30" height="30" transform="translate(1500 722)" fill="#2ab170" />
                                    </clipPath>
                                  </defs>
                                  <g id="Mask_Group_395" data-name="Mask Group 395" transform="translate(-1500 -722)" clip-path="url(#clip-path)">
                                    <g id="grid" transform="translate(1500.217 722)">
                                      <g id="Group_90690" data-name="Group 90690" transform="translate(0)">
                                        <g id="Group_90689" data-name="Group 90689">
                                          <path id="Path_452567" data-name="Path 452567" d="M8.043,0H1.087a.87.87,0,0,0-.87.87V7.826a.87.87,0,0,0,.87.87H8.043a.87.87,0,0,0,.87-.87V.87A.87.87,0,0,0,8.043,0Z" transform="translate(-0.217)" fill="#2ab170" />
                                          <path id="Path_452568" data-name="Path 452568" d="M18.478,0H11.522a.87.87,0,0,0-.87.87V7.826a.87.87,0,0,0,.87.87h6.957a.87.87,0,0,0,.87-.87V.87A.87.87,0,0,0,18.478,0Z" transform="translate(-0.217)" fill="#2ab170" />
                                          <path id="Path_452569" data-name="Path 452569" d="M8.043,10.435H1.087a.87.87,0,0,0-.87.87v6.957a.87.87,0,0,0,.87.87H8.043a.87.87,0,0,0,.87-.87V11.3A.87.87,0,0,0,8.043,10.435Z" transform="translate(-0.217 0)" fill="#2ab170" />
                                          <path id="Path_452570" data-name="Path 452570" d="M18.478,10.435H11.522a.87.87,0,0,0-.87.87v6.957a.87.87,0,0,0,.87.87h6.957a.87.87,0,0,0,.87-.87V11.3A.87.87,0,0,0,18.478,10.435Z" transform="translate(-0.217 0)" fill="#2ab170" />
                                          <path id="Path_452571" data-name="Path 452571" d="M28.913,0H21.957a.87.87,0,0,0-.87.87V7.826a.87.87,0,0,0,.87.87h6.957a.87.87,0,0,0,.87-.87V.87A.87.87,0,0,0,28.913,0Z" transform="translate(-0.217)" fill="#2ab170" />
                                          <path id="Path_452572" data-name="Path 452572" d="M28.913,10.435H21.957a.87.87,0,0,0-.87.87v6.957a.87.87,0,0,0,.87.87h6.957a.87.87,0,0,0,.87-.87V11.3A.87.87,0,0,0,28.913,10.435Z" transform="translate(-0.217 0)" fill="#2ab170" />
                                          <path id="Path_452573" data-name="Path 452573" d="M8.043,21.3H1.087a.87.87,0,0,0-.87.87V29.13a.87.87,0,0,0,.87.87H8.043a.87.87,0,0,0,.87-.87V22.174A.87.87,0,0,0,8.043,21.3Z" transform="translate(-0.217 0)" fill="#2ab170" />
                                          <path id="Path_452574" data-name="Path 452574" d="M18.478,21.3H11.522a.87.87,0,0,0-.87.87V29.13a.87.87,0,0,0,.87.87h6.957a.87.87,0,0,0,.87-.87V22.174A.87.87,0,0,0,18.478,21.3Z" transform="translate(-0.217 0)" fill="#2ab170" />
                                          <path id="Path_452575" data-name="Path 452575" d="M28.913,21.3H21.957a.87.87,0,0,0-.87.87V29.13a.87.87,0,0,0,.87.87h6.957a.87.87,0,0,0,.87-.87V22.174A.87.87,0,0,0,28.913,21.3Z" transform="translate(-0.217 0)" fill="#2ab170" />
                                        </g>
                                      </g>
                                    </g>
                                  </g>
                            ...
                            <button type="button" class="btn-list">
                              <span class="icon">
                                <svg id="view-list" xmlns="http://www.w3.org/2000/svg" width="30" height="24.706" viewBox="0 0 30 24.706">
                                  <path id="Path_452576" data-name="Path 452576" d="M0,20.294H7.059V13.235H0Zm0,8.824H7.059V22.059H0ZM0,11.471H7.059V4.412H0Zm8.824,8.824H30V13.235H8.824Zm0,8.824H30V22.059H8.824Zm0-24.706v7.059H30V4.412Z" transform="translate(0 -4.412)" fill="#2ab170" />
                                </svg>
                              </span>
                            </button>
                          </div>
                              ...
                              <ul class="item-list">
                                <li>
                                  <div class="d-flex align-items-center">
                                    ...
                                    <div class="txt"><strong>ประเภทไฟล์ :</strong> .pdf</div>
                                  </div>
                                </li>
                                <li>
                                  <div class="d-flex align-items-center">
                                ...
                                <li>
                                  <div class="d-flex align-items-center">
                                    ...
                                    <div class="txt"><strong>จำนวนดาวน์โหลด :</strong> 120 ครั้ง</div>
                                  </div>
                                </li>
                              </ul>
                            </div>
                                ...
                                <div class="col-auto">
                                  <a href="" class="link -read-more">
                                    <div class="d-flex align-items-center">
                                      ...
                                      <div class="txt text-primary fw-bold">อ่านต่อ</div>
                                    </div>
                                  </a>
                                </div>
                                <div class="col-auto">
                                  <a href="" class="link">
                                    <div class="d-flex align-items-center">
                                      ...
                                      <div class="txt text-primary  fw-bold">ดาวน์โหลด</div>
                                    </div>
                                  </a>
                                </div>
                              </div>
