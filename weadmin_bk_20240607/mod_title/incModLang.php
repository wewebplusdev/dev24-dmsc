...
if($_SESSION[$valSiteManage."core_session_language"]=="Eng"){
		...
		$langMod["tit:selectlang"] ="select language";
}else{
		...
		$langMod["txt:subjectDe"] = "โปรดป้อนชื่อและคำบรรยาย เพื่อใช้ในการแสดงผลเนื้อหาในหน้ารวมข้อมูลทั้งหมดของเมนูนี้บนเว็บไซต์ของคุณ";
		...
		$langMod["tit:year"] ="ปี";
		$langMod["tit:selectlang"] ="เลือกภาษา";
}
?>
