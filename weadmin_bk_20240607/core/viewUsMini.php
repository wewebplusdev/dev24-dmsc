                                  ...
                                  <tr>
                                    ...
                                    <td align="left">
                                            <table  border="0" cellspacing="0" cellpadding="0" align="right">
                                                <tr>
                                                    <td align="right">
                                                        <div  class="btnEditView" title="<?=$langTxt["btn:edit"]?>"  onclick="editContactNew('../core/editUsMini.php');"></div>
