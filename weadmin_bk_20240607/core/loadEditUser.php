      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder " style="display:none;">
        ...
        <tr>
          <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
            ...
            <span class="formFontTileTxt"><?= $langTxt["us:titleTypeDe"] ?></span>
          </td>
        </tr>
        <tr>
...
document.myForm.inputGender[1].checked=true    " /></div>
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <label>
              <div class="formDivRadioL"><input name="inputGender" id="inputGender" type="radio" class="formRadioContantTb" checked="checked" onclick="document.myForm.inputPrefix[0].checked=true" <? if ($valGender == "Male") echo "checked"; ?> value="Male" /></div>
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <textarea name="inputlocation" id="inputlocation" cols="20" rows="5" class="formTextareaContantTb"><?= $valAddress ?></textarea>
          </td>
        </tr>
        <tr>
