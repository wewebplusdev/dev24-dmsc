      ...
      <div class="divRightMain">
         ...
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <div class="formDivView"><?= $valSdate ?> <? if ($valTypeDateTo == 1) { ?>- <?= $valEdate ?><? } ?></div>
               </td>
            </tr>
            <tr>
               <td width="18%" align="right" valign="top" class="formLeftContantTb"><?= $langMod["inp:salary"] ?>:<span class="fontContantAlert"></span></td>
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <div class="formDivView"><?= $modTxtSalary[$valTypeSal] ?>
                     <?php
                     if ($valTypeSal == 2) {
                        if ($valTypeTimeTo == 0) {
                           echo $valFromHH . '.' . $valFromMM . ' น.';
                        } else {
                           echo $valFromHH . '.' . $valFromMM . ' น. - ' . $valToHH . '.' . $valToMM . ' น.';
                        }
                     }  ?>
                  </div>
               </td>
         ...
         <br />
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder " <?php if ($valTypeC != 3) {
                                                                                                                  echo 'style="display:none;"';
                                                                                                               } ?>>
            <tr>
               <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
         ...
         <br <?php if ($valTypeC != 3) {
                  echo 'style="display:none;"';
               } ?> />
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder " <?php if ($valTypeC != 1) {
                                                                                                                  echo 'style="display:none;"';
                                                                                                               } ?>>
            <tr>
               <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
