...
<body>
   <form action="?" method="get" name="myForm" id="myForm" enctype="multipart/form-data">
      ...
      <input name="valCid" type="hidden" id="valCid" value="<?= $valCid ?>" />
         ...
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <select name="inputGroupID" id="inputGroupID" class="formSelectContantTb" onchange="openSelectSub('openSelectGroup.php', '#boxSubGroup')">
                     <option value="0"><?php echo $langMod["tit:selectg"]; ?></option>
                     <?php
                     $sql_group = "SELECT " . $mod_tb_group . "_id," . $mod_tb_group_lang . "_subject FROM " . $mod_tb_group . " INNER JOIN " . $mod_tb_group_lang . " ON " . $mod_tb_group . "_id = " . $mod_tb_group_lang . "_cid WHERE  " . $mod_tb_group . "_masterkey ='" . $_REQUEST['masterkey'] . "' AND " . $mod_tb_group_lang . "_language='" . $_REQUEST['inputLt'] . "'  ";
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb" id="boxSubGroup">
                  <select name="inputSubGroupID" id="inputSubGroupID" class="formSelectContantTb">
                     ...
                     AND " . $mod_tb_subgroup . "_gid='" . $valGid . "'  ";
                     ...
                     ?>
                        <option value="<?php echo $row_subgroupid ?>" <?php if ($valSGid == $row_subgroupid) { ?> selected="selected" <?php } ?>><?php echo $row_subgroupname ?>
                        </option>
                     <?php } ?>
                  </select>
               </td>
   ...
   <script type="text/javascript" language="javascript">
      ...
      function ajaxFileUpload() {
         ...
         jQuery.ajaxFileUpload({
            url: 'loadUpdatePic.php?myID=<?php echo $valCid ?>&masterkey=<?php echo $_REQUEST['masterkey'] ?>&langt=<?php echo $_REQUEST['inputLt'] ?>&delpicname=' + valuepicname + '&menuid=<?php echo $_REQUEST['menukeyid'] ?>',
            secureuri: false,
