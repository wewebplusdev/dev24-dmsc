...
$inputstatusname="Enable";
		...
		".$tablename."_lastbyid= '".$_SESSION[$valSiteManage.'core_session_id']."' ,
		".$tablename."_lastby= '".$_SESSION[$valSiteManage.'core_session_name']."' ,
		".$tablename."_lastdate= NOW()  
		 WHERE ".$tablename."_id='". $statusid."'";
