	...
	$.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				iframe   : '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0"' + (navigator.userAgent.match(/msie [6]/i) ? ' allowtransparency="true"' : '') + '></iframe>',
