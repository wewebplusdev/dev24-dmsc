        ...
        <div class="divRightMain">
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                ...
                <tr id="showtypemap" style="display: none">
                    ...
                    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                        <input name="typeg" type="hidden" value="" />
                        <?php echo  $langMod['info:latiture'] ?> : <input name="latiture" value="<?php echo  $ValConfig['glati'] ?>" />
                        <?php echo  $langMod['info:longtiture'] ?> : <input name="longtiture" value="<?php echo  $ValConfig['glongti'] ?>" />
                        <br />
