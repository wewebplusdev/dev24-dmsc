...
$sql = "SELECT " . $core_tb_menu . "_id , " . $core_tb_menu . "_icon, " . $core_tb_menu . "_namethai, " . $core_tb_menu . "_moduletype, " . $core_tb_menu . "_linkpath, " . $core_tb_menu . "_masterkey, " . $core_tb_menu . "_target, " . $core_tb_menu . "_nameeng," . $core_tb_menu . "_icontype, " . $core_tb_menu . "_classname    FROM " . $core_tb_menu . " WHERE " . $core_tb_menu . "_id='" . $_REQUEST["valEditID"] . "'";
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        <tr>
          <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
            ...
            <span class="formFontTileTxt"><?= $langTxt["mg:titleDe"] ?></span>
          </td>
        </tr>
        <tr>
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr>
          <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
            ...
            <span class="formFontTileTxt"><?= $langTxt["mg:titlesetDe"] ?></span>
          </td>
        </tr>
        <tr>
        ...
        <tr id="rowModule" <? if ($valModuletype == "Group" || $valModuletype == "Link") { ?> style="display:none" <? } ?>>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <table width="91%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left">
                  <input name="inputlinkpath" style="width:100%;" id="inputlinkpath" type="text" class="formInputContantTb" value="<?= $valLinkpath ?>" />
                </td>
...
">
                  <a href="javascript:void(0)" onclick="popup('popupIconWindow','menuMgFile.php',500,300,1)"><?= $langTxt["mg:inpfileAd"] ?></a>
                </td>
              </tr>
            </table>
          </td>
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr>
          <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
            ...
            <span class="formFontTileTxt"><?= $langTxt["mg:titleiconDe"] ?></span>
          </td>
        </tr>
        <tr>
          <td colspan="7" align="right" valign="top" height="15"></td>
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <label>
              <div class="formDivRadioL"><input name="inputIconType" id="inputIconType" type="radio" class="formRadioContantTb" <?php if ($valIcontype != "2" || $valIcontype == "") { ?>checked="checked" <?php } ?> value="1" onclick="
            ...
            <label>
              <div class="formDivRadioL"><input name="inputIconType" id="inputIconType" type="radio" class="formRadioContantTb" <?php if ($valIcontype == "2") { ?>checked="checked" <?php } ?> value="2" onclick="
	...
	">
        ...
        <tr id="icon-class" <?php if ($valIcontype != "2") { ?>style="display:none;" <?php } ?>>
          <td width="18%" align="right" valign="top" class="formLeftContantTb"><?= $langTxt["mg:inpiconclass"] ?></td>
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">

            <input name="inputClassIcon" id="inputClassIcon" type="text" class="formInputContantTb" placeholder="<?php echo $langTxt["mg:inpiconclassS"]; ?>" value="<?php echo $valClassName; ?>" />
