                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="84%" style="padding-left:10px;" align="left">
                                    ...
                                    ?>
                                    <a href="<?= $valLinkViewUser ?>"><span class="fontTitlTbHome"><?= $_SESSION[$valSiteManage . "core_session_name"] ?></span></a>
                                </td>
                            </tr>
                            <tr>
                ...
                ?>
                    <div class="divRightInnerTopBoxHome">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="8%" align="left">
                                    <div class="cycle1Login cycle-bg-2"><span class="feather icon-users"></span></div>
                                </td>
                    ...
                    <div class="divRightInnerTopBoxHome">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="8%" align="left">
                                    <div class="cycle4Login cycle-bg-3"><span class="feather icon-align-justify"></span></div>
                                </td>
