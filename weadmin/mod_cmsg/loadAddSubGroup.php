      ...
      <form action="?" method="get" name="myForm" id="myForm">
         ...
         <div class="divRightNav">
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
               <tr>
                  <td class="divRightNavTb" align="left" id="defTop"><span class="fontContantTbNav"><a href="<?php echo $valLinkNav1 ?>" target="_self"><?php echo $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a href="javascript:void(0)" onclick="btnBackPage('group.php')" target="_self"><?php echo $langMod["meu:group"] ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php echo $langMod["txt:titleaddg"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>(<?php echo $langTxt["lg:thai"] ?>)<?php } ?></span></td>
                  ...
                  <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                     <select name="inputTimeKm" id="inputTimeKm" class="formSelectContantTb">
                        ...
                        foreach ($mod_distance AS $distance) {
                           ?>
                           <option value="<?= $distance ?>"><?php echo $distance ?>
                           </option>
                           <?php
                        }
                        ?>
                  ...
                  <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                     <ul class="ul-select-multiple item-list" style="margin: 0;">
                        ...
                        while ($row_group = wewebFetchArrayDB($coreLanguageSQL, $query_group)) {
                           ...
                           $valPic = $core_pathname_upload . "/$masterkey_todo/pictures" . "/" . $row_group["pic"];
                           if (is_file($valPic)) {
                              $valPic = $valPic;
                           } else {
                           ...
                           <li class="box-data-work-all box-data-work-<?= $row_groupid ?>">
                              <div class="wrapper">
                                 <label>
                                    <input type="checkbox" value="<?= $row_groupid ?>" name="inputtodoID[]" id="inputtodoID<?= $row_groupid ?>"/>
                                    <img src="<?= $valPic ?>"/>
                                    <p>
                                       <?= $row_groupname ?>
                                    </p>
