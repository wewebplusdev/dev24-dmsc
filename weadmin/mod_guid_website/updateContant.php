...
<body>
    ...
    if ($execute == "update") {
        ...
        if ($count_check > 0) {
            ...
            $update[] = $mod_tb_root_lang . "_title='" . changeQuot($_POST['inputDesc']) . "'";
            $update[] = $mod_tb_root_lang . "_section='" . changeQuot($_POST['inputSection']) . "'";
            $update[] = $mod_tb_root_lang . "_url='" . changeQuot($_POST['inputurl']) . "'";
            $update[] = $mod_tb_root_lang . "_target='" . changeQuot($_POST['inputmenutarget']) . "'";
            $update[] = $mod_tb_root_lang . "_pic='" . changeQuot($_POST['picname']) . "'";
            $update[] = $mod_tb_root_lang . "_type='" . changeQuot($_POST['inputType']) . "'";
            ...
            $insertLang[$mod_tb_root_lang . "_title"] = "'" . changeQuot($_REQUEST['inputDesc']) . "'";
            $insertLang[$mod_tb_root_lang . "_section"] = "'" . changeQuot($_REQUEST['inputSection']) . "'";
