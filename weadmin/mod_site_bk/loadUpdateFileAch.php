...
<?php
	...
	if(!empty($_FILES['inputFileUpload2']['error'])){
		...
		$error = 'No file was uploaded..';
			...
			$inputFileToUpload=$_FILES['inputFileUpload4']['tmp_name'];
			$inputFileToName=$_FILES['inputFileUpload4']['name'];
        ...
        $sql="DELETE FROM ".$mod_tb_file." WHERE ".$mod_tb_file."_keyfile='achievements' ";
		...
		$insert[$mod_tb_file."_keyfile"]="'achievements'";
