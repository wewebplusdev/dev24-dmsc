      ...
      <div class="divRightMain">
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <div class="formDivView">
                     ...
                     WHERE  " . $mod_tb_root_group . "_masterkey ='" . $_REQUEST["masterkey"] . "' AND " . $mod_tb_root_group_lang . "_language='" . $_REQUEST['inputLt'] . "' ";
                     if (count($valTid) > 0) {
                        $sql_group .= "AND " . $mod_tb_root_group . "_id IN (" . implode(",", array_values($valTid)) . ") ";
                     }else{
                        $sql_group .= "AND 1=0 ";
                     }
         ...
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
            ...
            <tr <?php if ($valpicType == 1) { echo 'style="display:none;"'; } ?>>
               <td width="18%" align="right" valign="top" class="formLeftContantTb"><?php echo $langMod["inp:album"] ?><span class="fontContantAlert"></span></td>
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <div class="formDivView">
