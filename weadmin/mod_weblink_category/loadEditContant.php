   ...
   <script language="JavaScript" type="text/javascript">
      function executeSubmit() {
         with(document.myForm) {
            if (inputTagID.value == 0) {
               inputTagID.focus();
               jQuery("#inputTagID").addClass("formInputContantTbAlertY");
               return false;
            } else {
               jQuery("#inputTagID").removeClass("formInputContantTbAlertY");
            }
         ...
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <select name="inputTagID[]" id="inputTagID" class="formSelectContantTb select2" multiple>
                     ...
                     ?>
                        <option value="<?php echo $row_groupid ?>" <?php if (in_array($row_groupid, $valTid)) { ?> selected="selected" <?php } ?>><?php echo $row_groupname ?>
                        </option>
                     <?php } ?>
                  </select>
               </td>
