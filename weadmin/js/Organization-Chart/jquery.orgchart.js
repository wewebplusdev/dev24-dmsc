(function ($) {
    ...
    $.fn.orgChart.defaults = {
        data: [{id: 1, name: 'Root', parent: 0, img: ''}],
        showControls: false,
        allowEdit: false,
        onAddNode: null,
        onDeleteNode: null,
    ...
    function OrgChart($container, opts) {
        ...
        this.draw = function () {
            ...
            if (opts.allowEdit) {
                ...
                $container.find('.node .imgchart').click(function (e) {
        ...
        this.editImg = function (id) {
            var btnSelectFile = $("input[id='fileToUpload-" + id + "']");
            btnSelectFile.click();
            btnSelectFile.change(function () {
        ...
        this.newNode = function (parentId) {
            ...
            self.addNode({id: nextId, name: 'test', parent: parentId, img: ""});
        }
        ...
        this.addNode = function (data) {
            ...
            $.each(nodes, function (index, value) {
                // alert(index + ": " + value);
                htmlSet = $('div[node-id=' + index + '] #imgchart-' + index).html();
                nodes[index].data.img = htmlSet;
                //alert(htmlSet);
            });
    ...
    function Node(data) {
        ...
        this.formatNode = function (opts) {
            ...
            if (typeof data.img !== 'undefined') {
                descString = '<div class="imgchart" id="imgchart-' + this.data.id + '" rel="' + this.data.id + '">' + data.img + '</div>';
            } else {
                descString = '<div class="imgchart" id="imgchart-' + this.data.id + '" rel="' + this.data.id + '">Add image</div>';
            }

            //  console.log(self.data);

            picprofile += '<input type="file" class="addImg" name="fileToUpload-' + this.data.id + '" id="fileToUpload-' + this.data.id + '" />';
            ...
            return "<div class='node' node-id='" + this.data.id + "'>" + descString + nameString + picprofile + buttonsHtml + "</div>";
        }
    }
