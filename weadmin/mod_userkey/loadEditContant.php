...
<form action="?" method="get" name="myForm" id="myForm"  enctype="multipart/form-data">
  ...
  <tr>
    ...
    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
      ...
      <span class="formFontNoteTxt"><?= $langMod["inp:notecontrolkey"] ?></span>    </td>
  </tr>
  ...
  <tr>
    ...
    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
      <input name="inputSecretKeyHidden" id="inputSecretKeyHidden" type="hidden" class="formInputContantTb" readonly value="<?=$valSecretKey?>" />
       ...
       <textarea name="inputSecretKey" id="inputSecretKey" cols="45" rows="5" class="formTextareaContantTb" disabled="disabled"><?=$valSecretKey?></textarea>    </td>
  </tr>
<tr>
          <td width="18%" align="right" valign="top" class="formLeftContantTb"><?= $langMod["tit:noteg"] ?><span class="fontContantAlert"></span></td>
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
         
            <textarea name="inputComment" id="inputComment" cols="45" rows="5" class="formTextareaContantTb" ><?=$valNote?></textarea>                    </td>
        </tr>
 </table>
    <br />
