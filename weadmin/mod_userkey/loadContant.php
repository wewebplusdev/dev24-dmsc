...
<body>
        ...
        <div class="divRightMain list-responsive">
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
                <tr>
                    ...
                    <td align="left" valign="middle" class="divRightTitleTb"><span class="fontTitlTbRight"><?= $langMod["tit:inpName"] ?></span></td>
    ...
    <div style="width:29px; height:29px;  background:url(<?= $valPic ?>) center no-repeat; background-size: cover;background-repeat: no-repeat; border-radius: 50%;  "></div>    </td> -->
                                        <td width="583" align="left">
                                            <div class="widthDivM"><a href="javascript:void(0)" onclick="
                                                    ...
                                                    viewContactNew('viewContant.php');"><?= $valName ?></a></div>
                                            <span class="fontContantTbTime">

                                                <?= $langMod["tit:noteg"] ?>: <?php echo $valNote ?>
                                            </span>
  ...
  <tr>
   ...
   document.myFormHome.valEditID.value=<?= $valID ?>;
    viewContactNew('viewContant.php');" ><?= $valNameEn ?></a></div></td>
  </tr>
</table>    </td>
<? } ?> -->
                            <!-- <td  class="divRightContantOverTb"  valign="top"  align="center">
    <span class="fontContantTbupdate"><?= $valView ? $valView : "0" ?></span>
  </td> -->
                            <td class="divRightContantOverTb" valign="top" align="center">
                                <? if ($valPermission == "RW") { ?>
