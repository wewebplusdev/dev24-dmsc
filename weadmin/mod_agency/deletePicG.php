...
$update = array();
$update[] = $mod_tb_root_group_lang . "_pic  	=''";
$sql = "UPDATE " . $mod_tb_root_group_lang . " SET " . implode(",", $update) . " 
WHERE " . $mod_tb_root_group_lang . "_cid='" . $_REQUEST["valEditID"] . "'  
AND " . $mod_tb_root_group_lang . "_id='" . $_REQUEST["valCid"] . "'  
";
