      ...
      <div class="divRightMain">
         ...
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb"><textarea name="inputDescription" id="inputDescription" cols="45" rows="5" class="formTextareaContantTb"></textarea><br />
               </td>
            </tr>
            <tr id="boxInputlink">
         ...
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <label>
                     <div class="formDivRadioL"><input name="inputType" id="inputType" type="radio" class="formRadioContantTb" value="1" checked="checked" onchange="$('.typePic').show();$('.typeVdo').hide();$('.typeYoutube').hide();" /></div>
                     <div class="formDivRadioR"><?php echo $modTxtType[1] ?></div>
                  </label>

                  <label>
                     <div class="formDivRadioL"><input name="inputType" id="inputType" type="radio" class="formRadioContantTb" value="2" onchange="$('.typePic').hide();$('.typeVdo').hide();$('.typeYoutube').show();" /></div>
                     <div class="formDivRadioR"><?php echo $modTxtType[2] ?></div>
                  </label>

                  <label>
                     <div class="formDivRadioL"><input name="inputType" id="inputType" type="radio" class="formRadioContantTb" value="3" onchange="$('.typePic').hide();$('.typeYoutube').hide();$('.typeVdo').show();" /></div>
            ...
            <tr class="typeVdo" style="display:none;">
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  ...
                  <span class="formFontNoteTxt"><?php echo $langMod["inp:notevdo"] ?></span>
                  <div class="clearAll"></div>
