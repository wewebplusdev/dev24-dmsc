...
<head>
   ...
   <script language="JavaScript" type="text/javascript">
      ...
      function clickChkDate() {
         let valChkDate = jQuery('#inputChkDate').val();
      ...
      function clickChkTime() {
         let valChkTime = jQuery('#inputChkTime').val();
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <tr>
                        <td width="152"><input name="sdateInput" id="sdateInput" type="text" autocomplete="off" class="formInputContantTbShot" value="<?php echo  $sdateInput ?>" /></td>
                              ...
                              <tr>
                                 ...
                                 <td><select name="inputTimeFromHH" class="formSelectContantTbShort" id="inputTimeFromHH">
                                       <? for ($i = 0; $i <= 23; $i++) {
                                          ...
                                          <option value="<?php echo  $myi ?>" <? if ($myTimeHH == $i) {
                                                                                 echo " selected";
                                                                              } ?>>
                                             <?php echo  $myi ?>
                                          </option>
                                 ...
                                 <td><select name="inputTimeFromMM" class="formSelectContantTbShort" id="inputTimeFromMM">
                                       <? for ($i = 0; $i <= 59; $i++) {
                                          ...
                                          <option value="<?php echo  $myi ?>" <? if ($myTimeMM == $i) {
                                                                                 echo " selected";
                                                                              } ?>>
                                             <?php echo  $myi ?>
                                          </option>
