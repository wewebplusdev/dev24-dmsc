...
if ($_REQUEST['execute'] == "insert") {
   ...
   $insert[$mod_tb_root . "_isdateto"] = "'" . $_POST["inputIsDateTo"] . "'";
   $insert[$mod_tb_root . "_istimeto"] = "'" . $_POST["inputIsTimeTo"] . "'";
   $insert[$mod_tb_root . "_period"] = "'" . $_POST["inputTypeSal"] . "'";
   $insert[$mod_tb_root . "_stime"] = "'" . $_POST["inputTimeFromHH"] . ":" . $_POST["inputTimeFromMM"] . "'";
   $insert[$mod_tb_root . "_etime"] = "'" . $_POST["inputTimeToHH"] . ":" . $_POST["inputTimeToMM"] . "'";
