...
<body>
   ...
   if ($execute == "update") {
      ...
      $update[] = $mod_tb_root . "_isdateto='" . $_POST["inputIsDateTo"] . "'";
      $update[] = $mod_tb_root . "_istimeto='" . $_POST["inputIsTimeTo"] . "'";
      $update[] = $mod_tb_root . "_period='" . $_POST["inputTypeSal"] . "'";
      $update[] = $mod_tb_root . "_stime='" . $_POST["inputTimeFromHH"] . ":" . $_POST["inputTimeFromMM"] . "'";
      $update[] = $mod_tb_root . "_etime='" . $_POST["inputTimeToHH"] . ":" . $_POST["inputTimeToMM"] . "'";
