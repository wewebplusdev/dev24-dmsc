...
$sql .= "
   ...
   . "," . $mod_tb_root . "_isdateto as isdateto"
   . "," . $mod_tb_root . "_period as period"
   . "," . $mod_tb_root . "_istimeto as istimeto"
   . "," . $mod_tb_root . "_stime as stime"
   . "," . $mod_tb_root . "_etime as etime"
   . " ";
...
$valTypeDateTo = $Row['isdateto'];
$valTypeTimeTo = $Row['istimeto'];
$valTypeSal = $Row['period'];
$valsTime = explode(":", $Row['stime']);
$valFromHH = $valsTime[0];
$valFromMM = $valsTime[1];
$valeTime = explode(":", $Row['etime']);
$valToHH = $valeTime[0];
$valToMM = $valeTime[1];
...
<body>
   <form action="?" method="get" name="myForm" id="myForm" enctype="multipart/form-data">
      ...
      <input name="valCid" type="hidden" id="valCid" value="<?php echo  $valSGid ?>" />
      <input name="valrand" type="hidden" id="valrand" value="<?php echo  $myRand ?>" />
      ...
      <div class="divRightMain">
         ...
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <tr>
                        <td width="152"><input name="sdateInput" id="sdateInput" type="text" autocomplete="off" class="formInputContantTbShot" value="<?php echo  $valSdate ?>" /></td>
                        <td align="left" width="98" style="padding-left:10px;"> <label>
                              <div class="formDivRadioL"><input name="inputIsDateTo" id="inputIsDateTo" value="1" type="checkbox" class="formRadioContantTb" onclick="clickChkDate();" <? if ($valTypeDateTo == 1) { ?>checked="checked" <? } ?> /></div>
                              <div class="formDivRadioR"><?php echo  $langMod["tit:edate"] ?></div>
                           </label></td>
                        <td width="587"><span id="idDateTo1" <? if ($valTypeDateTo <= 0) { ?>style="display:none;" <? } ?>><input name="edateInput" id="edateInput" type="text" class="formInputContantTbShot" value="<?php echo  $valEdate ?>" /></span></td>
                     </tr>
                     <tr>
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <label>
                     <div class="formDivRadioL"><input name="inputTypeSal" id="inputTypeSal" value="1" type="radio" class="formRadioContantTb" <? if ($valTypeSal == 1) { ?>checked="checked" <? } ?> onclick="jQuery('#salInput1').hide()" /></div>
                     <div class="formDivRadioR"><?php echo  $modTxtSalary[1] ?></div>
                  </label>

                  <label>
                     <div class="formDivRadioL"><input name="inputTypeSal" id="inputTypeSal" value="2" type="radio" class="formRadioContantTb" <? if ($valTypeSal == 2) { ?>checked="checked" <? } ?> onclick="jQuery('#salInput1').show();" /></div>
                     <div class="formDivRadioR"><?php echo  $modTxtSalary[2] ?></div>
                  </label>
               </td>
            </tr>
            <tr id="salInput1" <? if ($valTypeSal == 1) { ?>style="display:none;" <? } ?>>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <tr>
                        ...
                        <td align="left" width="67" style="padding-left:10px;"> <label>
                              <div class="formDivRadioL"><input name="inputIsTimeTo" id="inputIsTimeTo" value="1" type="checkbox" class="formRadioContantTb" onclick="clickChkTime();" <? if ($valTypeTimeTo == 1) { ?>checked="checked" <? } ?> /></div>
                              <div class="formDivRadioR"><?php echo  $langMod["tit:edate"] ?></div>
                           </label></td>
                        <td width="636"><span id="idTimeTo1" <? if ($valTypeTimeTo <= 0) { ?>style="display:none;" <? } ?>>
                              <table width="130" border="0" cellspacing="0" cellpadding="1">
                                 <tr>
         ...
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <label>
                     <div class="formDivRadioL"><input name="inputTypeC" id="inputTypeC" type="radio" class="formRadioContantTb" value="1" <?php if ($valTypeC == 1) {
                                                                                                                                                echo 'checked="checked"';
                                                                                                                                             } ?> /></div>
                  ...
                  <label>
                     <div class="formDivRadioL"><input name="inputTypeC" id="inputTypeC" type="radio" class="formRadioContantTb" value="2" <?php if ($valTypeC == 2) {
                                                                                                                                                echo 'checked="checked"';
                                                                                                                                             } ?> /></div>
                  ...
                  <label>
                     <div class="formDivRadioL"><input name="inputTypeC" id="inputTypeC" type="radio" class="formRadioContantTb" value="3" <?php if ($valTypeC == 3) {
                                                                                                                                                echo 'checked="checked"';
                                                                                                                                             } ?> /></div>
         ...
         <br />
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder TypeLink" <?php if ($valTypeC != 3) {
                                                                                                                           echo "style='display:none;'";
                                                                                                                        } ?>>
            <tr>
               <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
            ...
            <tr>
               ...
               <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                  <label>
                     <div class="formDivRadioL"><input name="inputmenutarget" id="inputmenutarget" type="radio" class="formRadioContantTb" value="1" <?php if ($valTarget == 1) {
                                                                                                                                                         echo 'checked="checked"';
                                                                                                                                                      } ?> /></div>
                  ...
                  <label>
                     <div class="formDivRadioL"><input name="inputmenutarget" id="inputmenutarget" type="radio" class="formRadioContantTb" value="2" <?php if ($valTarget == 2) {
                                                                                                                                                         echo 'checked="checked"';
                                                                                                                                                      } ?> /></div>
         ...
         <br class="TypeLink" <?php if ($valTypeC != 3) {
                                 echo "style='display:none;'";
                              } ?> />
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder TypeDetail" <?php if ($valTypeC != 1) {
                                                                                                                              echo "style='display:none;'";
                                                                                                                           } ?>>
            <tr>
               <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
         ...
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder TypeDownload" <?php if ($valTypeC == 3) {
                                                                                                                              echo "style='display:none;'";
                                                                                                                           } ?>>
            <tr>
               <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
         ...
         <br class="TypeDownload" <?php if ($valTypeC != 2) {
                                       echo "style='display:none;'";
                                    } ?> />
         <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder TypeDetail" <?php if ($valTypeC != 1) {
                                                                                                                              echo "style='display:none;'";
   ...
   <script type="text/javascript" language="javascript">
      ...
      function ajaxFileUploadDoc() {
         ...
         jQuery.ajaxFileUpload({
            url: 'loadUpdateFile.php?myID=<?php echo  $valSGid ?>&masterkey=<?php echo  $_REQUEST['masterkey'] ?>&langt=<?php echo  $_REQUEST['inputLt'] ?>&nametodoc=' + valuefilename + '&menuid=<?php echo  $_REQUEST['menukeyid'] ?>',
            secureuri: true,
   ...
   <script type="text/javascript" language="javascript">
      jQuery(document).ready(function() {
         ...
         var valUploadFile = 0;
         var settings = {
            url: "loadUpdateAlbum.php?myID=<?php echo  $valSGid ?>&masterkey=<?php echo  $_REQUEST['masterkey'] ?>&langt=<?php echo  $_REQUEST['inputLt'] ?>&menuid=<?php echo  $_REQUEST['menukeyid'] ?>",
            dragDrop: false,
            fileName: "myfile",
