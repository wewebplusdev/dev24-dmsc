...
exports.init = function (req, res) {
    funcRoute(req, res, {
        "getKm": "getKm",
        "getKmDetail": "getKmDetail",
        "getKmGroup": "getKmGroup",
    });
}

async function getKmGroup(req, res) {
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cms']}_masterkey = '${config_array_masterkey['km']}' 
...
async function getKmDetail(req, res) {
    const method = req.body.method;
    const language = req.body.language;
