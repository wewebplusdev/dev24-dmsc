...
exports.init = function (req, res) {
    funcRoute(req, res, {
        "getNewsPeople": "getNewsPeople",
        "getNewsPeopleDetail": "getNewsPeopleDetail",
        "getNewsPeopleGroup": "getNewsPeopleGroup",
    });
}

async function getNewsPeopleGroup(req, res) {
    ...
    config_array_masterkey['nwp'] = config.fieldDB.masterkey.nwp
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cmg']}_masterkey = '${config_array_masterkey['nwp']}' 
...
async function getNewsPeople(req, res) {
    const method = req.body.method;
    const language = req.body.language;
    const order = req.body.order;
    const page = req.body.page;
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cms']}_masterkey = '${config_array_masterkey['nwp']}' 
...
async function getNewsPeopleDetail(req, res) {
    const method = req.body.method;
    const language = req.body.language;
    const contentid = req.body.contentid;
    const file_id = req.body.file_id;
