...
exports.init = function (req, res) {
    funcRoute(req, res, {
        "getLaws": "getLaws",
        "getLawsDetail": "getLawsDetail",
        "getLawsGroup": "getLawsGroup",
    });
}

async function getLawsGroup(req, res) {
    ...
    config_array_masterkey['lar'] = config.fieldDB.masterkey.lar
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cmg']}_masterkey = '${config_array_masterkey['lar']}' 
...
async function getLaws(req, res) {
    const method = req.body.method;
    const language = req.body.language;
    const order = req.body.order;
    const page = req.body.page;
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cms']}_masterkey = '${config_array_masterkey['lar']}' 
...
async function getLawsDetail(req, res) {
    const method = req.body.method;
    const language = req.body.language;
    const contentid = req.body.contentid;
