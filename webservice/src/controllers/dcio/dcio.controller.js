...
exports.init = function (req, res) {
    funcRoute(req, res, {
        "getDcio": "getDcio",
        "getDcioDetail": "getDcioDetail",
    });
}

async function getDcio(req, res) {
    ...
    config_array_masterkey['dcio'] = config.fieldDB.masterkey.dcio
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cms']}_masterkey = '${config_array_masterkey['dcio']}' 
...
async function getDcioDetail(req, res) {
    const method = req.body.method;
    const language = req.body.language;
