...
exports.init = function (req, res) {
    funcRoute(req, res, {
        ...
        "getAnnouncerDetail": "getAnnouncerDetail",
        "getAnnouncerGroup": "getAnnouncerGroup",
    });
}

async function getAnnouncerGroup(req, res) {
    ...
    config_array_masterkey['nwa'] = config.fieldDB.masterkey.nwa
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cmg']}_masterkey = '${config_array_masterkey['nwa']}' 
...
async function getAnnouncer(req, res) {
    const method = req.body.method;
    const language = req.body.language;
    const order = req.body.order;
    const page = req.body.page;
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cms']}_masterkey = '${config_array_masterkey['nwa']}' 
...
async function getAnnouncerDetail(req, res) {
    const method = req.body.method;
    const language = req.body.language;
