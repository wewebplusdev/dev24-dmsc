...
exports.init = function (req, res) {
    funcRoute(req, res, {
        "getGod": "getGod",
        "getGodDetail": "getGodDetail",
        "getGodGroup": "getGodGroup",
    });
}

async function getGodGroup(req, res) {
    ...
    config_array_masterkey['god'] = config.fieldDB.masterkey.god
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cmg']}_masterkey = '${config_array_masterkey['god']}' 
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cms']}_masterkey = '${config_array_masterkey['god']}' 
...
async function getGodDetail(req, res) {
    const method = req.body.method;
    const language = req.body.language;
    const contentid = req.body.contentid;
    const file_id = req.body.file_id;
