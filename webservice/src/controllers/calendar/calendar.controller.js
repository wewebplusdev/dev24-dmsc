...
exports.init = function (req, res) {
    funcRoute(req, res, {
        ...
        "getCalendarGroup": "getCalendarGroup",
    });
}

async function getCalendarGroup(req, res) {
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cms']}_masterkey = '${config_array_masterkey['cal']}' 
            ...
            if (select_list.length > 0) {
                ...
                if (select.length > 0) {
                    ...
                    for (let i = 0; i < select.length; i++) {
                        ...
                        arr_data[i].isdateto = select[i].isdateto;
                        arr_data[i].istimeto = select[i].istimeto;
