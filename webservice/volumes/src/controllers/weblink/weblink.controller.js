...
exports.init = function (req, res) {
    funcRoute(req, res, {
        ...
        "getWeblinkDetail": "getWeblinkDetail",
        "getWeblinkGroup": "getWeblinkGroup",
    });
}

async function getWeblinkGroup(req, res) {
    ...
    config_array_masterkey['wel'] = config.fieldDB.masterkey.wel
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cmg']}_masterkey = '${config_array_masterkey['wel']}' 
...
async function getWeblink(req, res) {
    const method = req.body.method;
    const language = req.body.language;
    const order = req.body.order;
    const page = req.body.page;
    ...
    if (result.code == code.success.code) {
        ...
        try {
            ...
            let sql_list = `SELECT 
                ...
                WHERE ${config_array_db['md_cms']}_masterkey = '${config_array_masterkey['wel']}' 
