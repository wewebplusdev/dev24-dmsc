            ...
            if (select_total.length > 0) {
                ...
                if (select.length > 0) {
                    ...
                    for (let i = 0; i < select.length; i++) {
                        ...
                        arr_data[i].pic = {
                            'real' : modulus.getPicturePath(select[i]['masterkey'], 'real', select[i]['pic']),
                            'pictures' : modulus.getPicturePath(select[i]['masterkey'], 'pictures', select[i]['pic']),
                            'office' : modulus.getPicturePath(select[i]['masterkey'], 'office', select[i]['pic']),
                        }
