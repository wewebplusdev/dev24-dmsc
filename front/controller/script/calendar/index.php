...
$menuActive = "calendar";
$listjs[] = '<script defer src="' . _URL . SCRIPT_PATH . $menuActive . '/js/script.js"></script>';
$listjs[] = '<script defer src="' . _URL . SCRIPT_PATH . $menuActive . '/js/calendar.js'.$lastModify.'"></script>';
