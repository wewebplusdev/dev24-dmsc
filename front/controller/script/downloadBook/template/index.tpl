                        ...
                        <a href="{$news_url}" class="link" target="{$target}">
                            ...
                            <div class="content">
                                <div class="content-wrapper">
                                    <div class="title">
                                        {$valueload_data->subject}
                                    </div>
                                    <div class="file-type">
                                        <ul class="item-list">
                                            {if $valueload_data->typec eq 2}
                                            <li>
                                                <span>{$languageFrontWeb->filetype->display->$currentLangWeb} :</span> <span>{$fileinfo.type}</span>
                                            </li>
                                            {/if}
                                            <li>
                                                <span>{$languageFrontWeb->numbervisits->display->$currentLangWeb} :</span> <span>{if $valueload_data->typec eq 2}{$valueload_data->attachment[0]->download|number_format}{else}
                                                {$valueload_data->view|number_format}{/if}</span> {$languageFrontWeb->view2->display->$currentLangWeb}
                                            </li>
                                        </ul>
                                    </div>
