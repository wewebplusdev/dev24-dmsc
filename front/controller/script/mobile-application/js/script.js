...
function toggleLayout(viewClass, listClass, gridClass, listId, gridId, thumbClass, headClass) {
...
$('.layout-view button').click(function () {
    if ($(this).hasClass('btn-grid')) {
        toggleLayout('.layout-view', 'layout-list', 'layout-grid', '#download-list', '-layout-list', '.col-thumb', '.col-head');
    } else {
