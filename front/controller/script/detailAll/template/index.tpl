            ...
            <div class="container">
                <div class="breadcrumb-block">
                    <ol class="breadcrumb">
                        ...
                        {/if}
                        <li>
                            <a href="{$ul}/{$menuActive}/{$load_data->item[0]->id}/{$load_data->item[0]->masterkey}/{$load_data->item[0]->gid}"
                                class="link">
                                ...
                                <div class="row align-items-center">
                                    {if $load_data->item[0]->creby neq ""}
                                        <div class="col-sm-auto">
                                            <div class="box">
                                                <strong> {$languageFrontWeb->creby->display->$currentLangWeb} :</strong>
                                                <span>{$load_data->item[0]->creby}</span>
                                            </div>
                                        </div>
                                    {/if}
                            ...
                            <div class="col-md-auto">
                                <div class="box">
                                    <div class="social-list">
                                        ...
                                        <ul class="item-list">
                                            <li>
                                                <a href="https://www.facebook.com/sharer/sharer.php?u={$fullurl}"
                                            ...
                                            <li>
                                                <a href="https://twitter.com/intent/tweet?url={$fullurl}" class="link"
                    ...
                    <div class="container">
                        {if $load_data->item[0]->type eq "url"}
                            ...
                            <div class="iframe-container">
                                ...
                                <iframe src="https://www.youtube.com/embed/{$myUrlCutAnd}" title="Inside Of Saturn&#39;s Rings"
                ...
                <div class="news-area">
                    <div class="container">
                        ...
                        <div class="row justify-content-between">
                            <div class="col">แสดงความคิดเห็น</div>
                            <div class="col">ย้อนกลับ</div>  
                        </div>
                    </div>
                </div>
            {/if}
