...
<link rel="preload" type="text/css" href="{$template}/assets/fonts/fonts.css{$LastVersionCache}"  as="style" onload="this.onload=null;this.rel='stylesheet'">
...
<link rel="preload" href="{$template}/assets/css/plug_modify.css{$LastVersionCache}" media="all" as="style" onload="this.onload=null;this.rel='stylesheet'">
...
<link rel="preload" href="{$template}/assets/css/jquery.mCustomScrollbar.css{$LastVersionCache}" as="style" onload="this.onload=null;this.rel='stylesheet'">
<noscript><link rel="stylesheet" href="{$template}/assets/css/jquery.mCustomScrollbar.css{$LastVersionCache}"></noscript>

<!-- asw icon -->
<link rel="preload" href="https://fonts.googleapis.com/icon?family=Material+Icons&amp;text=format_size,add,remove,restart_alt,close,title,link,local_parking,nightlight,brightness_5,tonality,filter_vintage,gradient,filter_b_and_w,local_library,zoom_in,mouse,format_bold,format_line_spacing,space_bar,spellcheck"  as="style" onload="this.onload=null;this.rel='stylesheet'">